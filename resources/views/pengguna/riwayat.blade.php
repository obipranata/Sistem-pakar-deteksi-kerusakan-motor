									...
									@foreach ($konsultasi as $k)
										<div class="col-lg-6">
											<div class="card text-white" style="background-color: #010A43">
												...
												<a href="/delete/riwayat/{{$k->kd_konsultasi}}" onclick="event.preventDefault();
												document.getElementById('delete-riwayat').submit();" class="btn btn-warning">
													<i class="fas fa-trash text-white"></i>
												</a>
												<form id="delete-riwayat" action="/delete/riwayat/{{$k->kd_konsultasi}}" method="POST">
													@csrf
													@method('DELETE')
												</form>
											</div>
